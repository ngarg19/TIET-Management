...
public class addteacher extends JFrame implements ActionListener{
    ...
    addteacher(){
        ...
        JLabel lblempid = new JLabel("Roll Number");
        lblempid.setBounds(50, 200, 200, 30);
        lblempid.setFont(new Font("serif", 1, 20));
        add(lblempid);

        empid = new JLabel("90101" + first4);
        empid.setBounds(200, 200, 200, 30);
        empid.setFont(new Font("serif", 1, 20));
        add(empid);
        ...
        String courses[] = {"B.Tech", "BE","BE-MBA","M.Tech","PhD"};
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            try {
                String query = "insert into teacher values('"+name+"', '"+fname+"', '"+rollno+"', '"+phone+"', '"+address+"', '"+dob+"', '"+email+"', '"+x+"', '"+xii+"', '"+Aadhar+"', '"+course+"', '"+branch+"')";
                conn con = new conn();
